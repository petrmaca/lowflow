...
# dt=select.recessionlimbs(finDT$Rcur,as.character(finDT$DTM),minlength=9, begOUt = 3, endOUt=5)
  ...
  dt=as.data.table(select.recessionlimbs_Xie(dta1b$R_mm_den,dta1b$DTM,minlength=9, endOUt=3))
...
write_fst(obsDF,path="tests/data/obsRL_CenteredDIFFS_3OR5begOUt_2endOut_Xie.fst")
